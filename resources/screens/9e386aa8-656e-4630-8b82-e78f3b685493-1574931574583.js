jQuery("#simulation")
  .on("click", ".s-9e386aa8-656e-4630-8b82-e78f3b685493 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/8122a80f-497f-4de0-80a4-fe810e03a7f9"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/ae8b2c19-2212-4cfe-b7fc-863a2e478e64"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/76daaa3a-8bf7-4ff7-bdf1-d7d1db9ebc53"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-9e386aa8-656e-4630-8b82-e78f3b685493 #s-Button span": {
                      "attributes": {
                        "color": "#80B8F1"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-9e386aa8-656e-4630-8b82-e78f3b685493 #s-Button_1 span": {
                      "attributes": {
                        "color": "#80B8F1"
                      }
                    }
  ...
  .on("change", ".s-9e386aa8-656e-4630-8b82-e78f3b685493 .change", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
